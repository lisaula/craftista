...
def create_products(config_data):
        print("Creating products table and inserting initial data if not exists...")
        ...
        cur = conn.cursor()
        try:
                if check_if_table_exists(cur, 'products'):
                        return
                else:
                        ...
                        cur.close()
                        conn.close()
                        print("Products table created and initial data inserted.")
        except:
                print("failed to connect to DB or create table")